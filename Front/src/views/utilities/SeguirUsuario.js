...
const UserTable = () => {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:8800/users/listar', {
            method: 'GET',
            headers: {
    ...
    const handleAddUser = (receiverId) => {
        ...
        console.log(" ID DEL SUARIO", senderId )
    ...
    const exportToPdf = () => {
        ...
        const headers = ['Nombre', 'Apellido Paterno', 'Apellido Materno', 'CI', 'Email', 'Teléfono', 'Especilidad'];
